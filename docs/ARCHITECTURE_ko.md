...
| `internal/app` | 현재 Hyper Run application runtime입니다. command routing, project state, runtime packet, Learn, Growth, Readiness, SQLite storage, repair, update, doctor check를 담당합니다. |
